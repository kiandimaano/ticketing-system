...
x_train_vec = vectorizer.fit_transform(x_train) # Learn from training tickets and convert them to numbers
x_test_vec = vectorizer.transform(x_test) # Convert test tickets to numbers using the same learned rules
